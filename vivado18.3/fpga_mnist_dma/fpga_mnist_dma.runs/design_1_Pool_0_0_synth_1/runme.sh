...
HD_PWD='D:/Project/vivado_pro/fpga/fpga_mnist_dma/fpga_mnist_dma.runs/design_1_Pool_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Pool_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Pool_0_0.tcl
