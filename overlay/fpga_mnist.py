...
w_conv1=readbinfile("/home/xilinx/jupyter_notebooks/mnist/overlay/mnist/data/W_conv1.bin",KERNEL_HEIGHT1*KERNEL_WIDTH1*IN_CH1*OUT_CH1)
...
B_conv1=readbinfile("/home/xilinx/jupyter_notebooks/mnist/overlay/mnist/data/b_conv1.bin",OUT_CH1)
for i in range(OUT_CH1):
	b_conv1[i]=B_conv1[i]

w_conv2=readbinfile("/home/xilinx/jupyter_notebooks/mnist/overlay/mnist/data/W_conv2.bin",KERNEL_HEIGHT2*KERNEL_WIDTH2*IN_CH2*OUT_CH2)
...
B_conv2=readbinfile("/home/xilinx/jupyter_notebooks/mnist/overlay/mnist/data/b_conv2.bin",OUT_CH2)
for i in range(OUT_CH2):
	b_conv2[i]=B_conv2[i]

w_fc1=readbinfile("/home/xilinx/jupyter_notebooks/mnist/overlay/mnist/data/W_fc1.bin",KERNEL_HEIGHT3*KERNEL_WIDTH3*IN_CH3*OUT_CH3)
...
B_fc1=readbinfile("/home/xilinx/jupyter_notebooks/mnist/overlay/mnist/data/b_fc1.bin",OUT_CH3)
for i in range(OUT_CH3):
	b_fc1[i]=B_fc1[i]

w_fc2=readbinfile("/home/xilinx/jupyter_notebooks/mnist/overlay/mnist/data/W_fc2.bin",KERNEL_HEIGHT4*KERNEL_WIDTH4*IN_CH4*OUT_CH4)
...
B_fc2=readbinfile("/home/xilinx/jupyter_notebooks/mnist/overlay/mnist/data/b_fc2.bin",OUT_CH4)
...
for i in range(10):
	...
	for i in range(1,OUT_CH4):
		if(h_fc2[0][0][i]>MAX):
			MAX=h_fc2[0][0][i]
			result=i
	print("The Final Recognition Result is "+str(result))
